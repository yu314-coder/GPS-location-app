...
extension Notification.Name {
    ...
    static let workoutLocationUpdated = Notification.Name("WorkoutLocationUpdated")
    static let openLiveSessionRequested = Notification.Name("OpenLiveSessionRequested")
}
